...
from molecule.molecule import resonance
...
import molecule.molecule.fragment
...
class TestFragment(unittest.TestCase):
    def setUp(self):
        ...
        self.fragment1 = molecule.molecule.fragment.Fragment()
        ...
        cutting_label_L2 = molecule.molecule.fragment.CuttingLabel('L')
    ...
    def test_is_subgraph_isomorphic1(self):
        ...
        from molecule.molecule.group import Group
    ...
    def test_assign_representative_species(self):
        ...
        expected_repr_spec = Molecule().from_smiles('C=CC(C)(CCCCCCCC(C)(C=C)C(C)C(C)C=CC)C(C)C(C)C=CC')

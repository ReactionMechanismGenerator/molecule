...
from molecule.molecule.graph import Graph, Vertex
from molecule.molecule.molecule import Atom, Bond, Molecule
from molecule.molecule.atomtype import get_atomtype, AtomTypeError
...
class Fragment(Graph):
    ...
    def draw(self, path):
        ...
        vector formats.
        """
        from molecule.molecule.draw import MoleculeDrawer
